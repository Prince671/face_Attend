...
const eventTagMap = {
  ...
  restricted_student_detected: ['Attendance', 'Dashboard', 'AdminDashboard', 'Notifications'],
  ...
  chat_message_created: ['ChatGroups', 'ChatMessages'],
  chat_message_updated: ['ChatGroups', 'ChatMessages', 'ChatGallery'],
  chat_message_deleted: ['ChatGroups', 'ChatMessages', 'ChatGallery'],
  chat_reaction_updated: ['ChatGroups', 'ChatMessages'],
  chat_mention: ['ChatGroups', 'Notifications'],
